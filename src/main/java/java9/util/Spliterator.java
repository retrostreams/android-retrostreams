 ...
 * {@link Spliterator#tryAdvance(java9.util.function.Consumer)}
 * and {@link Spliterator#forEachRemaining(java9.util.function.Consumer)} box
 * primitive values to instances of their corresponding wrapper class.  Such
 * boxing may undermine any performance advantages gained by using the primitive
 * specializations.  To avoid boxing, the corresponding primitive-based methods
 * should be used.  For example,
 * {@link Spliterator.OfInt#tryAdvance(java9.util.function.IntConsumer)}
 * and {@link Spliterator.OfInt#forEachRemaining(java9.util.function.IntConsumer)}
 * should be used in preference to
 * {@link Spliterator.OfInt#tryAdvance(java9.util.function.Consumer)} and
 * {@link Spliterator.OfInt#forEachRemaining(java9.util.function.Consumer)}.
 ...
 * non-deterministic results when using the {@code java9.util.stream} framework.
 *
 ...
 * {@code java9.util.stream} package, would use Spliterator in a parallel
...
public interface Spliterator<T> {
    ...
    public interface OfInt extends OfPrimitive<Integer, IntConsumer, OfInt> {
         ...
         * {@link #tryAdvance(java9.util.function.IntConsumer)}; otherwise
        ...
        default boolean tryAdvance(Consumer<? super Integer> action) {
            if (action instanceof IntConsumer) {
                ...
                return tryAdvance(RefConsumer.toIntConsumer(action));
            }
        }
         ...
         * If the action is an instance of {@code IntConsumer} then it is cast
         * to {@code IntConsumer} and passed to
         * {@link #forEachRemaining(java9.util.function.IntConsumer)}; otherwise
         * the action is adapted to an instance of {@code IntConsumer}, by
         * boxing the argument of {@code IntConsumer}, and then passed to
        ...
        default void forEachRemaining(Consumer<? super Integer> action) {
            if (action instanceof IntConsumer) {
                ...
                forEachRemaining(RefConsumer.toIntConsumer(action));
            }
        }
    }
    ...
    public interface OfLong extends OfPrimitive<Long, LongConsumer, OfLong> {
         ...
         * {@link #tryAdvance(java9.util.function.LongConsumer)}; otherwise
        ...
        default boolean tryAdvance(Consumer<? super Long> action) {
            if (action instanceof LongConsumer) {
                ...
                return tryAdvance(RefConsumer.toLongConsumer(action));
            }
        }
         ...
         * If the action is an instance of {@code LongConsumer} then it is cast
         * to {@code LongConsumer} and passed to
         * {@link #forEachRemaining(java9.util.function.LongConsumer)}; otherwise
         * the action is adapted to an instance of {@code LongConsumer}, by
         * boxing the argument of {@code LongConsumer}, and then passed to
        ...
        default void forEachRemaining(Consumer<? super Long> action) {
            if (action instanceof LongConsumer) {
                ...
                forEachRemaining(RefConsumer.toLongConsumer(action));
            }
        }
    }
    ...
    public interface OfDouble extends OfPrimitive<Double, DoubleConsumer, OfDouble> {
         ...
         * {@link #tryAdvance(java9.util.function.DoubleConsumer)}; otherwise
        ...
        default boolean tryAdvance(Consumer<? super Double> action) {
            if (action instanceof DoubleConsumer) {
                ...
                return tryAdvance(RefConsumer.toDoubleConsumer(action));
            }
        }
        ...
        default void forEachRemaining(Consumer<? super Double> action) {
            if (action instanceof DoubleConsumer) {
                ...
                forEachRemaining(RefConsumer.toDoubleConsumer(action));
            }
        }
    }
}
