 ...
 * {@linkplain java9.util.stream.Stream streams}. For example, you can compute
 ...
 * {@linkplain java9.util.stream.Stream#collect(Collector) reduction}
 * target for a {@linkplain java9.util.stream.Stream stream}. For example:
 *
 * <pre> {@code
 ...
 * {@link java9.util.stream.Collectors#summarizingDouble(java9.util.function.ToDoubleFunction)
