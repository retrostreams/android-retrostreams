 ...
 * for <a href="package-summary.html">java9.util.stream</a> for additional
 * specification of streams, stream operations, stream pipelines, and
 * parallelism.
 *
 * @since 1.8
 * @see Stream
 * @see <a href="package-summary.html">java9.util.stream</a>
 */
public interface LongStream extends BaseStream<Long, LongStream> {
     ...
     * {@link java9.util.stream.BaseStream#close() closed} after its contents
     ...
     * stream source (such as {@link LongStream#generate(LongSupplier)}) or removing the
     ...
     * {@link LongStream#generate(LongSupplier)}) or removing the ordering constraint with
