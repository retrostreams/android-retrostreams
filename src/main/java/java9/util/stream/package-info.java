 ...
 * {@link java9.util.stream.BaseStream#isParallel()} method, and the
 * stream's mode can be modified with the
 * {@link java9.util.stream.BaseStream#sequential()} and
 * {@link java9.util.stream.BaseStream#parallel()} operations.
 ...
 * as {@link java9.util.function.Function}, and are often lambda expressions or
 * method references.
 *
 ...
 * terminal operations {@link java9.util.stream.Stream#forEach forEach} and
 * {@link java9.util.stream.Stream#forEachOrdered forEachOrdered}, side-effects
 ...
 * ordered stream unordered, such as {@link java9.util.stream.BaseStream#unordered()}.
 ...
 * the stream with {@link java9.util.stream.BaseStream#unordered() unordered()} may
 ...
 * {@link java9.util.stream.Stream#reduce(java9.util.function.BinaryOperator) reduce()}
 * and {@link java9.util.stream.Stream#collect(java9.util.stream.Collector) collect()},
 * as well as multiple specialized reduction forms such as
 * {@link java9.util.stream.IntStream#sum() sum()}, {@link java9.util.stream.IntStream#max() max()},
 * or {@link java9.util.stream.IntStream#count() count()}.
 *
 ...
 * {@link java9.util.stream.Stream#collect(Collector) collect()},
 ...
 * {@link java9.util.stream.Collector} to capture all three aspects.  The
 ...
 * composability.  The class {@link java9.util.stream.Collectors} contains a
 ...
 * {@link java9.util.stream.Collectors#groupingBy(java9.util.function.Function, java9.util.stream.Collector) groupingBy}:
 *
 * <pre>{@code
 ...
 *
 * <p>A {@link java9.util.stream.Collector} that supports concurrent reduction is
 * marked with the {@link java9.util.stream.Collector.Characteristics#CONCURRENT}
 ...
 * stream being processed. The {@link java9.util.stream.Stream#collect(Collector)}
 * implementation will only perform a concurrent reduction if
 * <ul>
 * <li>The stream is parallel;</li>
 * <li>The collector has the
 * {@link java9.util.stream.Collector.Characteristics#CONCURRENT} characteristic,
 * and;</li>
 * <li>Either the stream is unordered, or the collector has the
 * {@link java9.util.stream.Collector.Characteristics#UNORDERED} characteristic.
 * </ul>
 * You can ensure the stream is unordered by using the
 * {@link java9.util.stream.BaseStream#unordered()} method.  For example:
 * <pre>{@code
 *     Map<Buyer, List<Transaction>> salesByBuyer
 *         = txns.parallelStream()
 *               .unordered()
 ...
 * }</pre>
 * (where {@link java9.util.stream.Collectors#groupingByConcurrent} is the
 ...
 * {@link java.util.Collection#stream()} or {@link java9.util.J8Arrays#stream(Object[])}
 * to obtain a stream.  How are those stream-bearing methods implemented?
 *
 * <p>The class {@link java9.util.stream.StreamSupport} has a number of
 * low-level methods for creating a stream, all using some form of a
 * {@link java9.util.Spliterator}. A spliterator is the parallel analogue of an
 ...
 * {@link java9.util.Spliterators#spliteratorUnknownSize(java.util.Iterator, int)}.
 ...
 * {@link java9.util.Spliterator#characteristics() characteristics} of the
 ...
 * {@link java9.util.stream.StreamSupport#stream(java9.util.function.Supplier, int, boolean) stream()}.
