 ...
 * {@link TerminalOp#evaluateParallel(PipelineHelper, java9.util.Spliterator)},
 * {@link TerminalOp#evaluateSequential(PipelineHelper, java9.util.Spliterator)},
 * and {@link AbstractPipeline#opEvaluateParallel(PipelineHelper, java9.util.Spliterator,
 * java9.util.function.IntFunction)}, methods, which can use the
