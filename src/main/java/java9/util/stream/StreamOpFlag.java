 ...
 * derived from the equivalent {@link java9.util.Spliterator} characteristics:
 * {@link java9.util.Spliterator#DISTINCT}, {@link java9.util.Spliterator#SORTED},
 * {@link java9.util.Spliterator#ORDERED}, and
 * {@link java9.util.Spliterator#SIZED}.  A spliterator characteristics bit set
 * can be converted to stream flags using the method
 * {@link #fromCharacteristics(java9.util.Spliterator)} and converted back using
 ...
 * {@link java9.util.Spliterator#SUBSIZED} that information can be utilized to
...
enum StreamOpFlag {
     ...
     * clear or inject this value.
     * <p>
     * Note: The {@link java9.util.Spliterator#SORTED} characteristic can define
